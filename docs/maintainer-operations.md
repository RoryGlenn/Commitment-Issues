...
The tarball must remain at or below **350 KiB compressed** and **878 KiB
...
user documentation add 5,804 measured unpacked bytes. It increased from 806 to
812 KiB for issue #308's active-operation guard, whose runtime, changelog, and
user documentation add 6,009 measured unpacked bytes. It increased from 812 to
817 KiB for issue #309's special-index-state guard, whose runtime, changelog,
and user documentation add 4,900 measured unpacked bytes. The compressed
ceiling did not need to change. It increased from 817 to 827 KiB for issue
#310's interrupted-fixer refusal, whose runtime, changelog, and shipped safety
documentation add 10,037 measured unpacked bytes. The compressed ceiling again
...
did not need to change. It increased from 833 to 852 KiB for issue #312's
ownership-preserving prepare composition, including fail-closed heredoc and
...
bytes unpacked. It increased from 852 to 878 KiB for issue #313's immutable
staged-tree checks, whose runtime and shipped documentation add 26,652 measured
unpacked bytes. The exact package is 897,708 bytes unpacked; the compressed
